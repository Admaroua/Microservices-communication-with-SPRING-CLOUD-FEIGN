...
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Etudiant etudiant1=new Etudiant(null,"marwa", Date.valueOf("2001-06-03"),"4-siw",Date.valueOf("2020-12-14"),etab1,1L,null,null);
        Etudiant etudiant2=new Etudiant(null,"adem", Date.valueOf("2001-06-03"),"4-isi",Date.valueOf("2020-12-14"),etab2,2L,null,null);
        Etudiant etudiant3=new Etudiant(null,"yacine", Date.valueOf("2001-06-03"),"4-siw",Date.valueOf("2020-12-14"),etab1,3L,null,null);
